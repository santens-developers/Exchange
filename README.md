...
ПТУ.СчетФактура.Номер = 87698769;
ПТУ.СчетФактура.Дата = ТекущаяДата();
...
Товар.Штрихкод.Добавить(46787898799);
Товар.Штрихкод.Добавить(46787898749);
Товар.Штрихкод.Добавить(46787834399);
...
<ПТУ xmlns="http://www.santens.ru/exchange" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" Номер="8798790" Дата="2019-10-30">
	...
	<Товар УникальныйИдентификатор="9711c4e6-b5e0-46ca-add8-2734fbfd33d4">
		<Код>МТ-987987ф</Код>
